...
@ManagedBean
@ViewScoped
public class OrderList extends BaseController implements Serializable {
	...
	public void filterData() {
		...
		filters.add(new FilterExample("company.person", loginUtil.getCurrentUser().getPerson(), InequalityConstants.EQUAL));
